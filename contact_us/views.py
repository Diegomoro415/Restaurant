...
def handler404(request, exception=None):
    ...
    :return: Rendered HTML template for the custom 404 error page with a 404 status code.
    """
...
def handler403(request, exception=None):
    ...
    :param request: The HTTP request object.
    :param exception: The exception that triggered the error (not used here).
    :return: Rendered HTML template for the custom 403 error page with a 403 status code.
    """
...
def handler500(request):
    ...
    :param request: The HTTP request object.
    :return: Rendered HTML template for the custom 500 error page with a 500 status code.
    """
