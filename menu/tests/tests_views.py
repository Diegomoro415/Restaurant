...
class MenuViewsTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        This method is run once to create a
        test image file for menu image testing.
        """
    ...
    def test_menu_list_view(self):
        ...
        This test checks if the menu list view is
        rendered successfully and uses the correct template.
        """
        ...
        self.assertTemplateUsed(
            response, 'Menu/list.html'
        )  # Expecting the correct template

    def test_menu_detail_view(self):
        """
        Test rendering of the menu detail view.

        This test checks if the menu detail view is
        rendered successfully and uses the correct template.
        """
