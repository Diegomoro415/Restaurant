...
class UserReview(models.Model):
    ...
    """
    # Define a foreign key relationship with the User model for the review's author
    author = models.ForeignKey(User, on_delete=models.CASCADE, default=1, verbose_name="Author")
    ...
    slug = models.SlugField(max_length=200, unique=True, null=True, verbose_name="Slug")

    class Meta:
        # Define the default ordering of UserReview instances by creation date
        ordering = ['-created_on']
        verbose_name_plural = "User Reviews"

    def __str__(self):
        """
        Return a human-readable string representation of the UserReview instance.
        """
